...
const pages = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            migration_key: 'initial:page:home:categories:popular',
            label: 'Выбор покупателей',
            title: 'Бестселлеры',
            description: 'Позиции с хорошим рейтингом и понятным наличием.',
            reference_kind: 'category_slug',
            reference_key: 'popular',
            url: '/category/popular',
            sort: 1,
          },
          {
            migration_key: 'initial:page:home:categories:new',
            label: 'Новинки',
            title: 'Новые поступления',
            description: 'Свежие комплекты и товары для спокойного обновления спальни.',
            reference_kind: 'category_slug',
            reference_key: 'new',
            url: '/category/new',
            sort: 2,
          ...
          {
            migration_key: 'initial:page:home:categories:catalog',
            label: 'Весь каталог',
            title: 'Все категории',
            description: 'Фильтры помогут быстро подобрать размер, материал и цену.',
            reference_kind: 'category_slug',
            reference_key: 'all',
            url: '/catalog',
            sort: 3,
      ...
      {
        migration_key: 'initial:page:home:collection',
        internal_name: 'Главная — CMS-подборка',
        section_type: 'collection_teaser',
        sort: 3,
        eyebrow: 'Подборка',
        title: 'Выбор для спокойной спальни',
        body:
          '<p>Актуальные товары и разделы, которые помогают быстро собрать мягкий комплект для дома.</p>',
        primary_cta_label: 'Смотреть каталог',
        primary_cta_url: '/catalog',
        layout_variant: 'rail',
        items: [
          {
            migration_key: 'initial:page:home:collection:bestsellers',
            title: 'Подборка для главной',
            description: 'Популярные позиции и готовые направления для быстрого выбора.',
            reference_kind: 'storefront_collection',
            reference_key: 'home-bestsellers',
            sort: 1,
          },
        ],
      },
