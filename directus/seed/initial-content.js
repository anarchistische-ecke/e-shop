...
const pages = [
  {
    ...
    sections: [
        ...
        items: [
          {
            ...
            description: 'Детали и итоговую стоимость доставки после оформления согласует менеджер.',
            url: '/info/delivery',
            sort: 1,
          },
          {
        ...
        items: [
          {
            ...
            description: 'Менеджер согласует детали доставки после оформления, а мы аккуратно упакуем заказ.',
            sort: 1,
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Менеджер быстро подтвердил заказ и согласовал удобные детали доставки.',
            sort: 3,
          },
        ],
      },
      {
        ...
        body:
          '<p>Начните с бестселлеров, добавьте плед или выберите ткань по ощущению. Детали доставки после оформления согласует менеджер, а оплату можно пройти онлайн.</p>',
        primary_cta_label: 'Смотреть бестселлеры',
        primary_cta_url: '/category/kpb',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Доставка по России',
        body:
          '<p>Менеджер согласует удобный способ получения и финальную стоимость доставки после оформления заказа.</p><p>Мы бережно упаковываем текстиль, чтобы он приехал чистым и целым.</p>',
      },
      {
    ...
    sections: [
      {
        ...
        sort: 1,
        eyebrow: 'Сервис',
        title: 'Детали доставки согласует менеджер',
        body: paragraphs(
          'Доставляем заказы по России курьером и в пункты выдачи.',
          'После оформления менеджер уточнит адрес, доступные варианты и итоговую стоимость доставки.'
        ),
        style_variant: 'quiet',
        layout_variant: 'contained',
      },
        ...
        items: [
          {
            ...
            title: 'Детали и стоимость',
            description:
              'Менеджер согласует способ получения, сроки и итоговую стоимость доставки после оформления заказа.',
            sort: 1,
          },
          {
            ...
            description:
              'Мы бережно упаковываем текстиль, чтобы заказ приехал чистым, целым и готовым радовать с первой распаковки.',
            sort: 2,
          },
        ],
      },
      {
        ...
        body: htmlList([
          'Срок доставки зависит от региона, выбранной службы и способа получения.',
          'Менеджер свяжется после оформления и согласует детали доставки.',
...
const faq = [
  {
    ...
    question: 'Как согласуется стоимость доставки?',
    answer:
      '<p>После оформления заказа менеджер уточнит адрес, доступные способы получения и согласует итоговую стоимость доставки.</p>',
    category: 'delivery',
    is_featured: true,
    sort: 1,
  },
