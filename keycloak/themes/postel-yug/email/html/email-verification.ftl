            ...
            <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;background:#ffffff;border-radius:22px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
                <tr>
                    <td style="padding:28px 32px 12px;">
                        ...
                        <h1 style="margin:16px 0 10px;font-size:30px;line-height:1.15;font-family:'Times New Roman',Georgia,serif;font-weight:600;color:#2b2221;">Подтвердите e-mail</h1>
                        <p style="margin:0 0 14px;color:#4f4a46;font-size:16px;line-height:1.5;">Чтобы завершить регистрацию в ${realmName!'Постельное Белье-Юг'}, подтвердите адрес электронной почты.</p>
                        <div style="margin:24px 0 8px;">
                            <a href="${link!'#'}" style="display:inline-block;background:#b65b4a;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:999px;font-weight:600;font-size:15px;">Подтвердить e-mail</a>
                        </div>
